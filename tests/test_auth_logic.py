...
def test_auth_mode_auto_prioritizes_oauth():
    ...
    client = DiscogsClient(
        consumer_key="ck", consumer_secret="cs", token="t", secret="s", auth_mode="auto"
    )
...
def test_auth_mode_auto_falls_back_to_token():
    ...
    client = DiscogsClient(
        consumer_key="ck", consumer_secret="cs", token="t", auth_mode="auto"
    )
...
def test_auth_mode_auto_falls_back_to_key_secret():
    ...
    client = DiscogsClient(consumer_key="ck", consumer_secret="cs", auth_mode="auto")
...
def test_auth_mode_force_oauth_fails_if_missing_keys():
    ...
    client = DiscogsClient(consumer_key="ck", consumer_secret="cs", auth_mode="oauth")
