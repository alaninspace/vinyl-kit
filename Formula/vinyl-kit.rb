class VinylKit < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/alaninspace/vinyl-kit/releases/download/v0.16.1/vinylkit-macos-arm64.zip"
    ...
    url "https://github.com/alaninspace/vinyl-kit/releases/download/v0.16.1/vinylkit-linux-amd64.tar.gz"
